      ...
      <div className="w-full max-w-4xl">
        <div className="flex flex-col md:flex-row items-center justify-between border border-gray-300 rounded p-4 mb-6 bg-white">
          ...
          <div className="flex gap-3">
            <button onClick={() => {navigate('/auth/register')}} className="px-4 py-2 text-sm font-medium text-blue-700 border border-blue-600 rounded hover:bg-blue-50 transition-colors">
              Register
            </button>
        ...
        <div className="border border-gray-300 rounded overflow-hidden">
          <div className="bg-gray-50 border-b border-gray-300 p-4">
            <h2 className="font-semibold text-gray-700">Log In</h2>
          </div>
